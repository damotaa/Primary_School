...
<h3>See All Students:</h3>
      <br>
        ...
        <th width="250px">Parents ID<br><hr></th>
          ...
          // Establish Connection to the data base and request info from the table using Sql and Display printing in html <tr>
          $sql = mysqli_query($connect, "SELECT Student_id, sName, Last_name, Address, Email, Parents_id  FROM Student");
      ...
      <!-- Selecting Parents Name -->
       ...
       <select name="Parents_id">
          ...
          <?php 
            ...
            // Chase parents information from the data base
            $sql = mysqli_query($connect, "SELECT Parents_id, sName, Last_name FROM Parents_Guardians;");
            while ($row = $sql->fetch_assoc()){
            echo "<option value=" . $row['Parents_id'] . ">" . $row['sName'] . " " . $row['Last_name'] . "</option>";
   ...
   if (isset($_POST['addstudent'])) {
      ...
      $ClassName = $_POST['Class_id'];
			...
			$sql = "INSERT INTO Student (sName, Last_name, Email, Address, Phone_Number, Parents_id, Class_id) VALUES ('$f_name', '$l_name', '$s_email', '$s_address', '$s_phonenumber', '$Parent_id', '$ClassName')";
			echo $sql;
   ...
   if (isset($_POST['delete_student'])) {
     ...
     $sql = "DELETE FROM Student WHERE Student_id = $row_id";
        ...
        <form action="student.php" method="POST">
          ...
          <?php
              ...
              // Check if form is submitted
                ...
                $studentid = $_POST ['update_id'];
              
                // Update ID row from database
                $sql = "UPDATE Student SET Email = '$update_email', Phone_Number = '$update_number', Address = '$update_address' where Student_id = '$studentid' ";
                //echo $sql;
